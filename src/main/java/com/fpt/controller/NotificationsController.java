...
public class NotificationsController {
    ...
    public String saveNotification(@Valid NotificationDTO dto, BindingResult result, Model model, Principal principal, RedirectAttributes redirectAttributes) {

        if (principal == null) {
            return "redirect:/login";
        }

        if (dto.getTitle() == null || dto.getContent() == null || dto.getTitle().isEmpty() || dto.getContent().isEmpty()) {
        ...
        if (result.hasErrors()) {
            ...
            List<CapstoneProjects> capstoneProjects = capstoneProjectService.getAllProject();
            model.addAttribute("capstoneProjects", capstoneProjects);
			redirectAttributes.addFlashAttribute("notification", "Error Post!");
            return "redirect:/td/notification";
        }
        ...
        if (success == true) {
			...
			redirectAttributes.addFlashAttribute("notification", "Posted Error!");
		}
        return "redirect:/td/notification";
    }
